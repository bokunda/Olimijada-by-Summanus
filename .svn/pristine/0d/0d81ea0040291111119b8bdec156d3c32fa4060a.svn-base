...
export class TurnirService {
	...
	DajPoslednjaDvaTurnira(): Observable<any[]>
    {
        let url = environment.serverUrl + 'poslednjaDvaTurnira';
	...
	DajSveMeceveNaTurniru(idTurnira: number): Observable<any>
	{
		let url = environment.serverUrl + 'turniri/mecevi';

		return this.http.post<any>(url,{idTurnira: idTurnira});
	}
	...
	*/
	...
	UzmiRezultateTurnira(idTurnira: number): Observable<any>
	{
		let url = environment.serverUrl+'rezultatiTurnira';

		return this.http.post<any[]>(url,{idTurnira: idTurnira });
	}

	UzmiMeceveSaTurnira(idTurnira: number): Observable<any>
	{
		let url = environment.serverUrl+'meceviNaTurniru';
