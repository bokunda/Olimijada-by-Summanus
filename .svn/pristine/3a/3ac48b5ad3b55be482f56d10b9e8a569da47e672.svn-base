...
@Component({
  selector: 'app-crtanje-kupa',
  templateUrl: './crtanje-kupa.component.html',
  styleUrls: ['./crtanje-kupa.component.css']
})
export class CrtanjeKupaComponent implements OnInit {
    ...
    nextRounds(LIST: any[], r = 1) {
        ...
        LIST.forEach((players, index) => {
            ...
            //round.push(`rd ${r}, mh ${index + 1} pobednik`);
            round.push(this.PLAYER_LIST[r])
    ...
    hardkodujPodatke()
    {
        ...
        this.PLAYER_LIST.push(['Bojan', 'Jelena']);
        this.PLAYER_LIST.push(['Jelena', 'David']);
        this.PLAYER_LIST.push(['Vuk', 'Nikola']);
        this.PLAYER_LIST.push(['Marko', 'Darko']);
        this.PLAYER_LIST.push(['Bojan', 'Jelena']);
        this.PLAYER_LIST.push(['Jelena', 'David']);
        this.PLAYER_LIST.push(['Vuk', 'Nikola']);
        this.PLAYER_LIST.push(['Marko', 'Darko']);
